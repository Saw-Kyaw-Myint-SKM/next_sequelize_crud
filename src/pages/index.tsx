...
export default function Home() {
  ...
  return (
    <Layout>
      <main
        className={`flex min-h-screen flex-col items-center w-full jutsify-between pt-20 ${inter.className}`}
      >
        <div className="">
          <Link
            href={"/create"}
          ...
          <div className="mt-4">
            {posts.map((post: any, index) => (
              <div key={index} className="my-4">
                <div className="bg-white max-w-4xl rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
